...
const SuperAdminSchema = Mongoose.Schema(
    ...
    let SuperAdminModel = Mongoose.model("superadmins", SuperAdminSchema);
  ...
  // });
  SuperAdminModel.getXPerson = (where) => {
        return SuperAdminModel.findOne({  _id:"61d1b461b974ab6f0b816c73" });
      };
